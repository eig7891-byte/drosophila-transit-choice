...
def _resolve_data_dir():
    candidates = [
        os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), 'data', 'connectome'),
        os.path.join(os.path.dirname(__file__), '..', '..', 'data', 'connectome'),
        os.path.join(os.getcwd(), 'data', 'connectome')
    ]
    for c in candidates:
        if os.path.exists(c):
            return c
